...
config :links, Links.Web.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r{priv/gettext/.*(po)$},
      ~r{lib/links/web/views/.*(ex)$},
      ~r{lib/links/web/templates/.*(eex)$}
    ]
  ]
...
config :links, :google_strategy, if(System.get_env("LINKS_MOCK_OAUTH") == "true", do: Links.Oauth.Mock, else: Links.Oauth.Google)
